...
import { ShieldAlert, FileText, CheckCircle2, AlertTriangle, Scale, RefreshCw, Sparkles, Upload, FileCode } from 'lucide-react';
...
export default function App() {
  ...
  const loadSample = async () => {
    ...
    try {
      ...
      setError('Failed to fetch sample text');
    }
  };
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans antialiased">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Left Column: Input and Testing Controls */}
